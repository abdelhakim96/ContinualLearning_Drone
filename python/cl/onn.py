...
onn_network.partial_fit(np.asarray([[1.8, 1.5]]), np.asarray([1]))
onn_network.partial_fit(np.asarray([[0.0, 0.0]]), np.asarray([0]))

# Predict classes
predictions = onn_network.predict(np.asarray([[0.0, 0.0], [1.8, 1.5]]))
print(predictions)
